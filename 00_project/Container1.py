...
class Cont1:
    def __init__(self, window):
        ...
        self.search_port_button = tk.Button(self.buttonframe, text="Search Port", command=main.update_combobox, width=15, height=4)
        self.search_port_button.pack(padx=5, pady=0, anchor=tk.NW, side=tk.LEFT)
        # hover color
        self.search_port_button.bind("<Enter>", lambda event, widget=self.search_port_button: main.on_enter(widget))
        self.search_port_button.bind("<Leave>", lambda event, widget=self.search_port_button: main.on_leave(widget))

        self.open_button = tk.Button(self.buttonframe, text="Open", command=main.on_open, width=15, height=4)
        self.open_button.pack(padx=5, pady=0, anchor=tk.NW, side=tk.LEFT)

        self.close_button = tk.Button(self.buttonframe, text="Close", command=main.on_close, width=15, height=4)
        ...
        self.start_tc_button = tk.Button(self.buttonframe, text="Start TC", command=main.on_start_tc, width=15, height=4)
        self.start_tc_button.pack(padx=5, pady=0, anchor=tk.NW, side=tk.LEFT)

        self.stop_tc_button = tk.Button(self.buttonframe, text="Stop TC", command=main.on_stop_tc, width=15, height=4)
        self.stop_tc_button.pack(padx=5, pady=0, anchor=tk.NW, side=tk.LEFT)

        # self.layout = tk.Label(self.buttonframe)
        # self.layout.pack(padx=10 ,anchor=tk.NW, side=tk.LEFT)

        self.su_button = tk.Button(self.buttonframe, text="SU", command=lambda: main.on_su(container7), width=8, height=4)
        self.su_button.pack(padx=5, pady=0, anchor=tk.NW, side=tk.LEFT)

        self.root_button = tk.Button(self.buttonframe, text="Root", command=lambda: main.on_root(container7), width=8, height=4)
        self.root_button.pack(padx=5, pady=0, anchor=tk.NW, side=tk.LEFT)

        self.shift_f2_button = tk.Button(self.buttonframe, text="Shift+F2", command=main.on_shift_f2, width=15, height=4)
        self.shift_f2_button.pack(padx=5, pady=0, anchor=tk.NW, side=tk.LEFT)

        self.shift_f3_button = tk.Button(self.buttonframe, text="Shift+F3", command=main.on_shift_f3, width=15, height=4)
        ...
        self.open_excel_button = tk.Button(self.buttonframe, text="Open Excel", command=main.on_open_excel, width=15, height=4)
